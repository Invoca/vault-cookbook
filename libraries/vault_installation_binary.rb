    ...
    class VaultInstallationBinary < Chef::Provider
      ...
      def self.binary_checksum(node, resource)
        ...
        when 'darwin-i386'
          ...
          when '0.11.0' then '91ae6dc2d85ebb52328df2a7e95d3e08de21d29657f11c17fc5032e3d29de7bd'
          end
        when 'darwin-amd64'
          case resource.version
          ...
          when '0.11.0' then '3c70f82cacb105804579c7825a92d3b9dd97ad90c8ee34861290ea4ce60d1063'
          end
        when 'freebsd-i386'
          case resource.version
          ...
          when '0.11.0' then 'e3e1bdacf9c05326efc8219a801309bbbdb8f1e6cf4970d306ef0fc4323ac0aa'
          end
        when 'freebsd-amd64'
          case resource.version
          ...
          when '0.11.0' then 'c24bba915ddbb9645c72a0352b1e9adfe66d18471b5892fae6ce767245aa139f'
          end
        when 'freebsd-arm'
          case resource.version
          ...
          when '0.11.0' then 'e29ef11651ccda15cb48fbdd799c7117eff43c0b5e3587f2cec3b74f93fbd2ba'
          end
        when 'linux-i386'
          case resource.version
          ...
          when '0.11.0' then '04324c2d2cd2a442b0789ca933e8cff99d7d6c73fef7718b6450dc261978a8f8'
          end
        when 'linux-amd64'
          case resource.version
          ...
          when '0.11.0' then '1681579a5a158a76e37de2854307d649b75ceddd663e71580df25baae036c267'
          end
        when 'linux-arm'
          case resource.version
          ...
          when '0.11.0' then '20a21167d2094cfe6f109736bad1de965cbe6cf94dbf2e671a5bc7cfe537edfe'
          end
        when 'windows-i386'
          case resource.version
          ...
          when '0.11.0' then '8e4c9aa98856dbf28e76ede2f2f3d91a2735f2bb8170825666ad526c4fe97f68'
          end
        when 'windows-amd64'
          case resource.version
          ...
          when '0.11.0' then '55a74c450474a28467ef4d50c350e075adf73ec87d92834e4756442674652949'
          end
        end
      end
    end
